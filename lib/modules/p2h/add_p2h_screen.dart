            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: InputText(
                          key: const ValueKey('sleep_duration_minutes'),
                          ...
                          onSaved: (value) {
                            ...
                            _formData['sleep_duration_minutes'] = hours != null
                                ? (hours * 60).round()
                                : null;
                          },
                        ),
                      ...
                      Expanded(
                        child: DropdownWidget<Options>(
                          ...
                          onChanged: (value) {
                            ...
                            _formData['body_condition'] = value?.value;
                          },
                        ),
                      ),
                    ],
                ...
                InputText(
                  ...
                  onSaved: (value) {
                    _formData['work_shift_id'] = today?.shift?.id;
                  },
                  initialValue: today?.shift != null
