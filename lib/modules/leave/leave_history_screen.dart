...
class _LeaveHistoryScreenState extends ConsumerState<LeaveHistoryScreen> {
  ...
  void _onScroll() {
    ...
    if (_scrollController.position.pixels >=
      ...
      _hasMore = ref.read(leaveHistoryProvider.notifier).hasMore;
      if (!_hasMore) return;
      _isLoadingMore = true;
      ref.read(leaveHistoryProvider.notifier).loadMore().then((_) {
  ...
  Widget build(BuildContext context) {
    ...
    final hasMore = ref.read(leaveHistoryProvider.notifier).hasMore;
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                filterPills(
                  onTap: () {
                    ref.read(leaveHistoryProvider.notifier).setFilter('');
                  },
                  title: 'Semua',
                  ref: ref,
                  value: '',
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Container(
                          ...
                          child: GestureDetector(
                            ...
                            onTap: () {
                              context.push('/leave/details/${item.id}');
                            },
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Gap(4),
                                                Text(
                                                  '${DateFormat('dd MMM yy', 'id-ID').format(DateTime.parse(item.start_date))} - ${DateFormat('dd MMM yy', 'id-ID').format(DateTime.parse(item.end_date))}',
                                                  style: TextStyle(
                                                    fontSize: 14,
                                                    fontWeight: FontWeight.w700,
                                                  ),
...
class filterPills extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final _selected = ref.read(leaveHistoryProvider.notifier).filter;
