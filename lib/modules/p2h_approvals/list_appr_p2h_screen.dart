...
class ListApprP2hScreen extends ConsumerStatefulWidget {
  const ListApprP2hScreen({super.key});

  @override
  ConsumerState<ListApprP2hScreen> createState() => _ListApprP2hScreenState();
}

class _ListApprP2hScreenState extends ConsumerState<ListApprP2hScreen> {
  ...
  void _onScroll() {
    ...
    if (_scrollController.position.pixels >=
      ...
      _hasMore = ref.read(listApprP2hProvider().notifier).hasMore;
      if (!_hasMore) return;
      _isLoadingMore = true;
      ref.read(listApprP2hProvider().notifier).loadMore().then((_) {
  ...
  Widget build(BuildContext context) {
    final historyAsync = ref.watch(listApprP2hProvider());
    final hasMore = ref.read(listApprP2hProvider().notifier).hasMore;
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${item.user.position} - ${item.user.department}",
                                            style: TextStyle(
                                              fontSize: 12,
