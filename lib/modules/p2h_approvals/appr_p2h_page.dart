...
import 'package:flutter_eapps/modules/p2h_approvals/list_appr_p2h_screen.dart';
...
class ApprP2hPage extends ConsumerStatefulWidget {
  const ApprP2hPage({super.key});

  @override
  ConsumerState<ApprP2hPage> createState() => _ApprP2hPageState();
}

class _ApprP2hPageState extends ConsumerState<ApprP2hPage>
      ...
      body: SafeArea(
        ...
        child: Column(
          children: [
            ...
            //   ],
            // ),
            Expanded(child: ListApprP2hScreen()),
          ],
        ),
      ),
    );
